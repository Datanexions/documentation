...
[← Previous: Connections](connections.md) | [Next: Streams →](streams.md)
...
**Cause**: Stream references column order that doesn't exist in scope.

**Solution**: Verify column orders in scope file match stream references.

### Error: "Type mismatch"

**Cause**: Formula expects number but column is string.

**Solution**: Fix type in scope file or adjust formula.

### Error: "Sheet not found"

**Cause**: Excel file doesn't have sheet specified in scope.

**Solution**: Check sheet name spelling (case-sensitive).
