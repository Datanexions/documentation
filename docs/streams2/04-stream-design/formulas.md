...
**Cause**: Column reference doesn't exist.

**Solution**: Verify column order in scope file.

### Error: "Cannot evaluate formula"

**Cause**: Syntax error in expression.

**Solution**: Check quotes, operators, parentheses.

### NULL Results

**Cause**: Source data has NULL values.

**Solution**: Handle NULLs or filter data before loading.
