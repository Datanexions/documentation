...
[← Previous: Variants](../03-configuration/variants.md) | [Next: Columns →](columns.md)
...
- [Columns](columns.md) - Define source columns
- [Create Operations](create-operations.md) - Object creation
- [Update Operations](update-operations.md) - Object updates
- [Formulas](formulas.md) - Calculated fields
- [Aggregations](aggregations.md) - Array aggregations
