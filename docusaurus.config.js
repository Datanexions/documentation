...
const config = {
  ...
  url: 'https://datanexions.github.io',
    ...
    [
      ...
      ({
        ...
        blog: {
          ...
          editUrl:
            'https://github.com/Datanexions/documentation/tree/main/',
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        style: 'dark',
        links: [],
        copyright: `Copyright © ${new Date().getFullYear()} Datanexions, SAS. Built with Docusaurus.`,
      },
      prism: {
